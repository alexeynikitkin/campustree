            ...
            <section class="section section-inner section-event">
                <div class="container">
                    ...
                    @php
                     ...
                     @endphp
                    <form id="leaf-creation-form" action="{{ route('updateLeaf', $post->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-12">
                                <div class="box-banner box-banner-drop">
                                    ...
                                    <input class="form-control" value="{{ $post->banner }}" type="hidden" id="feature_image2" name="banner" class="input" readonly required/>
                                </div>
                            </div>
                        </div>
                        {{--                        <div class="row">--}}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="input-container input-container-group">
                                        <input name="title" type="text" class="input" value="{{ $post->title }}" placeholder="Leaf Title" required>
                                        <span class="input-message __error">This field is required!</span>
                                    </label>
                                    ...
                                    <label class="input-container input-container-group">
                                        <textarea name="text" placeholder="About leaf" class="textarea">{{ $post->text }}</textarea>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label class="input-container input-container-group input-container-datepicker __top __right">
                                                @php
                                                    $arr = explode('-', $post->event_date );
                                                 @endphp
                                                <input value="{{ $arr[2].'/'.$arr[1].'/'.$arr[0]}}" type="text" name="event_date" class="input input-datepicker" placeholder="Date" readonly="readonly" required>
                                        ...
                                        <div class="col-lg-6">
                                            <label class="input-container input-container-group">
                                                <input type="text" value="{{ $post->event_time }}" name="event_time" class="input input-timepicker" placeholder="Time" readonly="readonly" required>
                                                <span class="input-container-icon __16 __right">
													<svg class="svg svg__16">
                                        ...
                                        <div class="col-lg-6">
                                            <label class="input-container input-container-group">
                                                <input type="text" value="{{ $post->location }}" class="input" name="location" placeholder="Location" required>
                                                <span class="input-message __error">This field is required!</span>
                                            </label>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="input-container input-container-group">
                                                <input type="text" value="{{ $post->map }}" name="map" class="input" placeholder="Google map link">
                                                <span class="input-message __error">This field is required!</span>
                                            </div>
                                        </div>
                                        {{--                                        <div class="col-12">--}}
                                        ...
                                        <div class="col-12">
                                            <div class="upload-container">
                                                <label class="input-container input-container-file">
                                                    <input class="form-control"  type="hidden" id="feature_image1" name="img" value="{{ $post->img }}" readonly required>
                                                    <span class="person-thumb">
                                                            <img src="/{{ $post->img }}" alt="" class="img-uploaded" width="100px" height="100px" style="display: block; margin-bottom: 10px"/>
                                                            <span class="person-thumb-upload">
                                                                <svg class="svg svg__16">
                                                                  <use xlink:href="/campustree/images/sprite/sprite.svg#upload"></use>
                                                                </svg>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="group group-buttons">
                                        ...
                                        <a data-router-disabled href="{{ route('events_on_review') }}" class="btn btn-outline">
